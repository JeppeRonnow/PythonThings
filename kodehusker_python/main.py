...
app.iconbitmap(cwd + '\kodehusker_python\lock-icon.ico')
...
frame.place(relx=0.5, rely=0.5, anchor=tkinter.CENTER, relwidth=0.32, height=70)

#kodeord felt
entry = customtkinter.CTkEntry(login_frame, corner_radius=10, placeholder_text="Indtast Kodeord", textvariable=kode, show="*", font=("Arial", 20), text_color=("black", "white"))
...
# Login knap
button = customtkinter.CTkButton(login_frame, text="Login", command=login_button, font=("Arial", 20), text_color=("black", "white"))
